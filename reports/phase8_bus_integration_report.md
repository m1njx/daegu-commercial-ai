...
가공된 버스 데이터는 [data/processed/transit/bus/daegu_bus_dong_features.parquet](../data/processed/transit/bus/daegu_bus_dong_features.parquet)에 안전하게 저장되었다.
...
[scripts/run_phase8_analysis.py](../scripts/run_phase8_analysis.py)를 실행하여 150개 행정동 전수를 대상으로 6대 대표 창업 시나리오의 랭킹 변동을 전수 측정하였다.
