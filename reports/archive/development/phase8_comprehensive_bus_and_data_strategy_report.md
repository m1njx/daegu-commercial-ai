...
> **기준 시점**: 2026-09-08  
> **프로젝트**: 대구 소상공인 AI 상권·창업 입지 추천 서비스 (`/Users/kangminje04/Daegu_data/`)  
...
가공된 버스 피처 마트는 [data/processed/transit/bus/daegu_bus_dong_features.parquet](file:///Users/kangminje04/Daegu_data/data/processed/transit/bus/daegu_bus_dong_features.parquet)에 저장되었습니다.
...
### 📁 생성된 파일 목록
1. [src/features/bus_features.py](file:///Users/kangminje04/Daegu_data/src/features/bus_features.py): 버스 원천 데이터 정제 및 Feature Mart 생성 모듈
2. [src/recommendation/transit_enhanced.py](file:///Users/kangminje04/Daegu_data/src/recommendation/transit_enhanced.py): 대중교통(철도+버스) 통합 스코어링 모듈
3. [scripts/run_phase8_analysis.py](file:///Users/kangminje04/Daegu_data/scripts/run_phase8_analysis.py): Phase 8 시뮬레이션 및 6대 시나리오 분석 스크립트
4. [scripts/run_phase8_tests.py](file:///Users/kangminje04/Daegu_data/scripts/run_phase8_tests.py): Phase 8 10대 자동화 테스트 스위트
5. [data/processed/transit/bus/daegu_bus_dong_features.parquet](file:///Users/kangminje04/Daegu_data/data/processed/transit/bus/daegu_bus_dong_features.parquet) / [.csv](file:///Users/kangminje04/Daegu_data/data/processed/transit/bus/daegu_bus_dong_features.csv): 150개 행정동 버스 Feature Mart
6. [data/processed/transit/bus/daegu_bus_stops_processed.parquet](file:///Users/kangminje04/Daegu_data/data/processed/transit/bus/daegu_bus_stops_processed.parquet): 3,981개 정류소 공간 데이터셋
7. [reports/phase8_experiment_results.json](file:///Users/kangminje04/Daegu_data/reports/phase8_experiment_results.json): 시뮬레이션 상세 수치 JSON
8. [reports/phase8_bus_integration_report.md](file:///Users/kangminje04/Daegu_data/reports/phase8_bus_integration_report.md): Phase 8 단독 기술 보고서
9. [reports/phase8_comprehensive_bus_and_data_strategy_report.md](file:///Users/kangminje04/Daegu_data/reports/phase8_comprehensive_bus_and_data_strategy_report.md): 전체 통합 마크다운 종합 보고서
